...
export const Footer = (props) => {
  const [showAccountSection, setShowAccountSection] = useState(
    props.showAccountSection !== undefined ? props.showAccountSection : true
  );
  const openLoginPopup = props.onLoginClick || (() => {});
  ...
  const handleShowAccountSection = (isShow) => {
    setShowAccountSection(isShow);
  };
  ...
  return (
    <footer className={styles.footer}>
      <div
        ...
        style={{ backgroundImage: 'url("https://useless-gold-stingray.myfilebase.com/ipfs/QmXbGqSZv3MwHrfBTf5CN1L5qdDAFEhe8HwZ74Y5Tbb2Tj")', width: '100%' }}
      >
