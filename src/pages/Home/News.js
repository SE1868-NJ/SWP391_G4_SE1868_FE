          ...
          <div className="news-list">
            ...
            <div className="news-item">
              <Link to="/news/1">
                ...
                <p>
                  Ngày 15/02/2024, EcoShipper chính thức mở chi nhánh tại Hà Nội
                  nhằm đáp ứng nhu cầu vận chuyển tăng cao của khách hàng.
                </p>
              </Link>
            </div>
            ...
            <div className="news-item">
              <Link to="/news/2">
                ...
                <p>
                  Hội thảo về cải tiến giao hàng nội khu, tập trung vào các
                  phương pháp tối ưu tuyến đường và giao hàng nhanh.
                </p>
              </Link>
            </div>
            ...
            <div className="news-item">
              <Link to="/news/3">
                ...
                />
                <h3>
                  EcoShipper hỗ trợ giao hàng miễn phí cho các tiểu thương
                </h3>
                <p>
                  Hỗ trợ giao hàng miễn phí trong nội khu cho các tiểu thương
                  trong thời gian lễ Tết, giúp việc kinh doanh dễ dàng hơn.
                </p>
              </Link>
            </div>
            ...
            <div className="news-item">
              <Link to="/news/4">
                ...
                <p>
                  Ra mắt dịch vụ "Giao hàng 1 giờ" tại các quận trung tâm, đảm
                  bảo tốc độ giao hàng nhanh nhất cho khách hàng nội khu.
                </p>
              </Link>
            </div>
            ...
            <div className="news-item">
              <Link to="/news/5">
                ...
                <p>
                  Tôn vinh những shipper đạt hiệu quả cao nhất trong tháng với
                  chương trình trao thưởng "Shipper xuất sắc nội khu".
                </p>
              </Link>
            </div>
            ...
            <div className="news-item">
              <Link to="/news/6">
                ...
                <p>
                  EcoShipper triển khai đội xe đạp điện tại các quận trung tâm,
                  vừa nhanh chóng vừa bảo vệ môi trường.
                </p>
              </Link>
            </div>
          </div>
          ...
          <div className="activities-list">
            ...
            <div className="activity-item">
              <Link to="/activities/1">
                ...
                <p>
                  EcoShipper phối hợp cùng các tổ chức từ thiện để mang đến
                  những món quà Tết cho các gia đình khó khăn tại vùng sâu vùng
                  xa.
                </p>
              </Link>
            </div>
            ...
            <div className="activity-item">
              <Link to="/activities/2">
                ...
                <p>
                  Hưởng ứng chiến dịch bảo vệ môi trường, EcoShipper tổ chức
                  trồng cây xanh tại các khu đô thị để tạo không gian xanh sạch
                  đẹp.
                </p>
              </Link>
            </div>
            ...
            <div className="activity-item">
              <Link to="/activities/3">
                ...
                <p>
                  EcoShipper cam kết hỗ trợ giáo dục bằng việc trao tặng học
                  bổng và dụng cụ học tập cho trẻ em có hoàn cảnh khó khăn.
                </p>
              </Link>
            </div>
            ...
            <div className="activity-item">
              <Link to="/activities/4">
                ...
                <p>
                  Cùng cộng đồng tham gia dọn dẹp rác thải, bảo vệ môi trường
                  xanh sạch đẹp tại các khu vực đông dân cư.
                </p>
              </Link>
            </div>
            ...
            <div className="activity-item">
              <Link to="/activities/5">
                ...
                <p>
                  EcoShipper kêu gọi nhân viên và cộng đồng tham gia hiến máu
                  nhân đạo, góp phần cứu sống nhiều bệnh nhân cần truyền máu.
                </p>
              </Link>
            </div>
            ...
            <div className="activity-item small">
              <Link to="/activities/6">
                ...
                <p>
                  EcoShipper triển khai chiến dịch phát cơm và quần áo ấm cho
                  người vô gia cư tại các thành phố lớn vào mùa đông.
                </p>
              </Link>
            </div>
          </div>
