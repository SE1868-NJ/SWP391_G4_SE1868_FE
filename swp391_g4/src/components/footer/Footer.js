...
const Footer = () => {
  return (
    <footer className={styles.footer}>
      <div className={styles.background} style={{ backgroundImage: `url('/FrameFooter.png')` }}>
        ...
        <div className={styles.mainContent}>
          <div className={styles.contentGrid}>
              ...
              <div className={styles.contactContainer}>
                <div className={styles.contactGrid}>
                    ...
                    <div className={styles.chatContainer}>
                        <a href="/shipper-contact" className={styles.chatButton}>
                            <img
                                loading="lazy"
                ...
                <div className={styles.emailContainer}>
                    ...
                    alt="Email icon"
                    />
                    <a href="mailto:ecoshipper2004@gmail.com" className={styles.emailText}>ecoshipper2004@gmail.com</a>
                </div>
            ...
            <p className={styles.socialText}>Kết nối với EcoShipper</p>
