        ...
        <div>
            ...
            <div style={{padding: "5rem 10rem",background:'rgb(245,245,245)'}}>
                ...
                <div className="d-flex">
                    <div className="w-100 p-5 d-flex justify-content-between rounded-start-4" style={ {background:' #fdfaf4'}} >
                        <div className="">
                ...
                <div className="w-100 bg-white p-5 rounded-4 my-2">
                    <div className="">
                            ...
                            <TableBody>
                                {products.map((product, index) => (
                                    <TableRow key={index}>
                                        ...
                                        <TableCell className="col-6">{product.ProductName}</TableCell>
                        ...
                        <Table>
                            <TableBody>
                                <TableRow>
                                    <TableCell  className="fw-bold fs-5 text-end ">Totall: </TableCell>
                                    <TableCell className="fw-bold fs-6 text-end col-2 "> <span className="me-4">{totalPrice} $</span></TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell  className="fw-bold fs-5 text-end ">Shipping Fee: </TableCell>
                                    <TableCell className="fw-bold fs-6 text-end col-2"> <span className="me-4">234asdsad $</span></TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell  className="fw-bold fs-4 text-end ">Total amount: </TableCell>
                                    <TableCell className="fw-bold fs-5 text-end col-2"> <span className="me-4">234asdsad $</span></TableCell>
                                </TableRow>
                            </TableBody>
                        </Table>
                    </div>
                ...
                <div className="w-100 bg-white p-5 rounded-4 d-flex justify-content-end">
                    <Button variant="success" size="lg" >Xác Nhận</Button>
                </div>
                <div>
