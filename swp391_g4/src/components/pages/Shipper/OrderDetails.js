...
const OrderDetails = () => {
  ...
  return (
    <div>
      ...
      <div className="orderdetail-container" style={{ padding: "5rem 10rem", background: "rgb(245,245,245)", paddingTop: "120px" }}>        <h2 className="text-center mb-5">Thông Tin đơn Hàng</h2>
        <div className="d-flex">
          ...
          >
            <div className="">
              ...
              <h5>
                <strong>
                  <i className="fa-solid fa-user"></i> &nbsp;{shop.ShopName}
                </strong>
              </h5>
              <span>
                <i className="fa-solid fa-phone"></i> &nbsp; (+84){" "}
                {shop.PhoneNumber}
              </span>
              <br />
              <span>
          ...
          >
            <div className="">
              ...
              <h5>
                <strong>
                  <i className="fa-solid fa-user"></i> &nbsp;{customer.FullName}
                </strong>
              </h5>
              <span>
                <i className="fa-solid fa-phone"></i> &nbsp; (+84){" "}
            ...
            <Table>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell className="fw-bold fs-5 text-center">
                    Price{" "}
                  </TableCell>
                  <TableCell className="fw-bold fs-5 text-center ">
                    Totall{" "}
              ...
              <TableBody>
                {products.map((product, index) => (
                  <TableRow key={index}>
                    <TableCell className="col-1 border-black">
                      {index + 1}
                    </TableCell>
                    <TableCell className="col-6 border-black">
                      {product.ProductName}
                    </TableCell>
                    <TableCell className="col-1 text-center border-black">
                      {product.Quantity}
                    </TableCell>
                    <TableCell className="col-2 text-end border-black">
                      <span className="me-4 border-black">
                        {" "}
        ...
        <div
          className="w-100 p-5 rounded-4 d-flex justify-content-end"
          style={{ background: "#caf4e0" }}
        >
          {order.OrderStatus === "Pending" && (
            <Button variant="success" size="lg" onClick={pickOrderHandler}>
              Xác Nhận
            </Button>
          )}
          ...
          {order.OrderStatus === "InProgress" && (
            <div>
              <Button
                ...
                size="lg"
                className="me-2"
                onClick={() => confirmOrderHandler("Delivered")}
              >
              ...
              <Button
                variant="danger"
                size="lg"
                onClick={() => confirmOrderHandler("Cancelled")}
              >
                Giao Hàng Thất Bại
              </Button>
            </div>
