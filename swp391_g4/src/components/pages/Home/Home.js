...
const Home = () => {
  ...
  return (
    <div className="home">
      <Header navigationItems={homeNavigationItems} showLoginButton={true} />
          ...
          <div className="slides-container">
            {bannerData.map((banner, index) => {
              ...
              if (index === currentBannerIndex) {
                ...
                (direction === 'left' && index === (currentBannerIndex - 1 + bannerData.length) % bannerData.length) ||
                (direction === 'right' && index === (currentBannerIndex + 1) % bannerData.length)
              ) {
                slideClass += ' prev';
              }
        ...
        <div className="valuesGrid">
          <article className="valueColumn">
            <div className="valueContent">
              ...
              <p className="paragraph">
                EcoShipper tin rằng những người trẻ, không có kinh nghiệm sẽ tiếp thu
          ...
          <article className="secondColumn">
            <div className="secondContent">
              ...
              <p className="paragraph">
                ...
                ngờ luôn là yếu tố rất được đề cao. EcoShipper cam kết tạo nên không
          ...
          <article className="thirdColumn">
            <div className="thirdContent">
              ...
              <p className="paragraph">
                Diễn biến nhanh chóng cùng những thay đổi linh hoạt tại EcoShipper đã
                tạo nên môi trường đầy khó khăn và thách thức, thành quả mà mỗi
                EcoShipper-er tạo ra là những giá trị chân thực và tức thời được mọi
      ...
      <section className="jobs-section">
        <div className="container">
          <h1>Mỗi cá nhân được trao quyền làm việc độc lập trong môi trường khuyến khích tự chủ và sáng tạo</h1>
              ...
              <article key={index} className="job-column">
                <div className="job-card">
                  ...
                  {job.roles.map((role, roleIndex) => (
                    <p key={roleIndex} className="job-text">{role}</p>
                  ))}
                  <img
                    loading="lazy"
                    src={job.icon}
