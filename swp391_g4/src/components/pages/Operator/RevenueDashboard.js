  ...
  return (
    <div className="panel">
      <div className="panel-header">
        <div className="panel-title">Tổng quan doanh thu</div>
      ...
      <div className="stats-grid">
        ...
        <div className="stat-card">
          <div className="stat-value">{formatCurrency(data.avgRevenue)}</div>
          <div className="stat-label">Doanh thu trung bình/đơn</div>
        </div>
        <div className="stat-card">
          <div className="stat-value">{formatCurrency(data.profitAfterFees)}</div>
          <div className="stat-label">Lợi nhuận sau phí</div>
        </div>
      </div>
...
function OrdersPanel({ orders }) {
  ...
  return (
    <div className="panel">
      <div className="panel-header">
        <div className="panel-title">Chi tiết doanh thu theo đơn hàng</div>
        <div className="panel-actions">
...
function RegionRevenuePanel({ revenueByRegion }) {
  ...
  return (
    <div className="panel">
      <div className="panel-header">
        <div className="panel-title">Doanh thu theo khu vực</div>
        <div className="panel-actions">
          <button onClick={handleExport}>Xuất báo cáo</button>
        </div>
      </div>
...
function ServiceRevenuePanel({ revenueByService }) {
  ...
  return (
    <div className="panel">
      <div className="panel-header">
        <div className="panel-title">Doanh thu theo loại dịch vụ</div>
        <div className="panel-actions">
          <button onClick={handleExport}>Xuất báo cáo</button>
        </div>
      </div>
...
function PaymentsPanel({ payments }) {
  ...
  return (
    <div className="panel">
      <div className="panel-header">
        <div className="panel-title">Lịch sử thanh toán</div>
        <div className="panel-actions">
          <button onClick={handleExport}>Xuất báo cáo</button>
        </div>
      </div>
          ...
          <tbody>
            {payments.map((payment) => (
              <tr key={payment.id}>
                ...
                <td>
                  <span className="status status-success">{payment.status}</span>
                </td>
              </tr>
            ))}
          </tbody>
...
function FeesPanel({ fees }) {
  return (
    <div className="panel">
      <div className="panel-header">
        <div className="panel-title">Tổng kết các khoản phí</div>
      </div>
      <div className="table-responsive">
        <table>
          <thead>
