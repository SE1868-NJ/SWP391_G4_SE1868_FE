    ...
    const fetchAllData = async () => {
      try {
        ...
        const [
          ...
          axios.get("http://localhost:4000/api/revenue-overview", {
            params: apiParams,
          }),
          axios.get("http://localhost:4000/api/revenue-by-day", {
            params: apiParams,
          }),
          axios.get("http://localhost:4000/api/revenue-by-region", {
            params: apiParams,
          }),
          axios.get("http://localhost:4000/api/revenue-by-service", {
            params: apiParams,
          }),
