...
import { Card, CardContent } from '../../components/buttons/Card';
import { Button } from '../../components/buttons/Button1';
import { Checkbox } from '../../components/buttons/CheckBox';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '../../components/buttons/Tabs';
import { Badge } from '../../components/buttons/Badges';
import { 
...
const ShipperDetail = () => {
  ...
  // Thêm cleanup effect để reset notification khi component unmount
  useEffect(() => {
    return () => {
      setNotification({
        isOpen: false,
  ...
  // Component popup thông báo đã được cải tiến
  const NotificationPopup = ({ isOpen, message, type, onClose }) => {
    console.log('NotificationPopup render, isOpen:', isOpen); // Thêm log để kiểm tra
      ...
      <div className="ShipperDetail-notification-overlay">
        <div className={`ShipperDetail-notification-popup ShipperDetail-${type}`}>
          <div className="ShipperDetail-notification-content">
            Shipper đã được duyệt thành công
          </div>
  ...
  // Hàm từ chối shipper đã được cập nhật
  ...
  // Hàm duyệt shipper đã được cập nhật
  const handleApproveShipper = async () => {
    if (!selectedShipper) {
      alert('Vui lòng chọn một shipper trước khi duyệt');
      return;
    }
    console.log('Bắt đầu duyệt shipper:', selectedShipper.ShipperID); // Kiểm tra xem hàm có chạy không
    try {
      const response = await axios.post('http://localhost:4000/api/approve-shipper', {
        shipperId: selectedShipper.ShipperID
      });
      console.log('Phản hồi từ API:', response.data); // Kiểm tra dữ liệu trả về
      ...
      if (response.data.success) {
        ...
        console.log('Cập nhật state notification'); // Kiểm tra trước khi set
        setNotification({
          isOpen: true,
        ...
        setTimeout(() => {
          console.log('Đóng thông báo và chuyển hướng');
  ...
  return (
    <div className="shipper-container">
      ...
      {/* Thông báo popup - đã được cập nhật không di chuyển trực tiếp từ onClose */}
      <NotificationPopup 
                            ...
                            <div className="info-grid">
                              <div className="info-item">
                                <div className="info-content">
                                  <p className="info-label"><strong>Họ và Tên</strong></p>
                              ...
                              <div className="info-item">
                                <div className="info-content">
                                  <p className="info-label"><strong>Số Điện Thoại</strong></p>
                              ...
                              <div className="info-item">
                                <div className="info-content">
                                  <p className="info-label"><strong>CMND/CCCD</strong></p>
                              ...
                              <div className="info-item">
                                <div className="info-content">
                                  <p className="info-label"><strong>Ngày Sinh</strong></p>
                              ...
                              <div className="info-item">
                                <div className="info-content">
                                  <p className="info-label"><strong>Địa chỉ</strong></p>
                        ...
                        <Card>
                          <CardContent>
                            ...
                            <div className="info-grid">
                              <div className="info-item">
                                <div className="info-content">
                                  <p className="info-label"><strong>Loại Phương Tiện</strong></p>
